...
- **Свежие страницы от OS** (через `mmap`) уже нулевые — ядро *обязано* отдавать обнулённые страницы (иначе бы процессы видели чужую память). Здесь Go не делает вообще ничего.
