...
Используй только когда точно контролируешь lifetime и отсутствие мутаций. В обычном коде — обычные конверсии. (Подробнее — в [08-strings](./08-strings.md#unsafe-конверсии-без-копии).)
