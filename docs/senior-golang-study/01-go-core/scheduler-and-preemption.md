...
- [Почему `GOMAXPROCS` важен](#почему-gomaxprocs-важен)
- [Preemption](#preemption)
- [Где scheduler чаще всего ощущается в production](#где-scheduler-чаще-всего-ощущается-в-production)
- [Типовые антипаттерны](#типовые-антипаттерны)
- [Как диагностировать](#как-диагностировать)
