...
- **coding-tasks/** — задачи на код, которые часто просят на собеседовании
  ...
  - **data-structures/** _(planned)_ — LRU cache, top-K, bloom filter, и т.д.
  - **system-primitives/** _(planned)_ — connection pool, retry с backoff, circuit breaker
  - **streams/** _(planned)_ — дедупликация, batching, sliding window
...
- [Algorithms And Data Structures](../17-algorithms-and-data-structures/README.md) — leetcode-style алгоритмы (два указателя, бинарный поиск, графы)
- [System Design Interview Cases](../05-system-design/interview-cases/README.md) — большие задачи (URL shortener, chat, ride-sharing)
- [Hands-On Labs](../14-hands-on-labs/README.md) — практические лабы для самостоятельной работы
- [Concurrency and Performance](../09-concurrency-and-performance/README.md) — глубокая теория concurrency
