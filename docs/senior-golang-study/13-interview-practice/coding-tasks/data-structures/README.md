...
Задачи на реализацию структур данных, которые часто спрашивают на собеседованиях. Это не leetcode (вопросы алгоритмов вынесены в [17-algorithms-and-data-structures/](../../../17-algorithms-and-data-structures/)), а **инженерные** реализации — с thread safety, метриками, edge cases.
...
- [Algorithms](../../../17-algorithms-and-data-structures/README.md) — теория структур данных (sort, heap, graph)
