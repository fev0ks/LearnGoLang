...
- [Concurrency и channels](../../../09-concurrency-and-performance/01-goroutines-and-channels.md) — детальная теория
- [Sync primitives](../../../09-concurrency-and-performance/02-sync-primitives.md) — mutex, atomic, sync.Map
- [Worker pool patterns](../../../09-concurrency-and-performance/03-worker-pool.md) — расширенные варианты
- [Context patterns](../../../09-concurrency-and-performance/04-context-patterns.md) — context propagation
