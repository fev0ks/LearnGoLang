...
- какую лабораторную можно сделать за 2-3 часа и получить максимум пользы;
- что именно измеряется в lab, кроме "работает/не работает";
- как превратить lab в разговорный кейс для интервью;
- что в реализации было самым рискованным и как это проверялось;
- как упростить lab для junior и усложнить для senior.
