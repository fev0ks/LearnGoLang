...
- [Пример](#пример)
- [CRUD простыми словами](#crud-простыми-словами)
- [Constraints](#constraints)
- [Почему constraints важны](#почему-constraints-важны)
- [Нормализация простыми словами](#нормализация-простыми-словами)
- [Что важно для Go backend](#что-важно-для-go-backend)
