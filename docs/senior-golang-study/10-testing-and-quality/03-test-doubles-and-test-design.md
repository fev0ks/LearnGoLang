...
- [Что в Go чаще работает лучше](#что-в-go-чаще-работает-лучше)
- [Когда mock уместен](#когда-mock-уместен)
- [Когда mock вреден](#когда-mock-вреден)
- [Fakes](#fakes)
- [How to design code for testability](#how-to-design-code-for-testability)
- [Пример stub/fake-подхода](#пример-stubfake-подхода)
