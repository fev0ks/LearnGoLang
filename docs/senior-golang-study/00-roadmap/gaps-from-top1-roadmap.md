...
| 4a | **Нагрузочное тестирование** (k6/Locust, bottleneck → фикс → перетест) | ✅ | [Нагрузочное тестирование](../09-testing-and-quality/load-testing/README.md) — выбор инструментов, модели нагрузки, k6, p95/p99, bottleneck и production-эксперименты |
