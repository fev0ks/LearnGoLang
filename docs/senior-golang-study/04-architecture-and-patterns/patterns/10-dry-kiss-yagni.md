...
Ошибка — применять DRY к **совпадению формы**, а не знания. Два фрагмента могут выглядеть одинаково **сейчас**, но меняться по разным причинам. Слив их в одну абстракцию, ты **связываешь** независимые части: изменение в одной ломает другую.
