...
- [Универсальная схема слоев](#универсальная-схема-слоев)
- [Где копится latency](#где-копится-latency)
- [Где обычно ломается система](#где-обычно-ломается-система)
- [Что надо показывать на схеме на интервью](#что-надо-показывать-на-схеме-на-интервью)
- [Минимальный набор метрик по пути запроса](#минимальный-набор-метрик-по-пути-запроса)
