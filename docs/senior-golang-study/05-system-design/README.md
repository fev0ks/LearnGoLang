...
[Пятинедельный учебный план](./learning-roadmap.md) выстраивает 41 тему от
структуры интервью и сетевого запроса до распределённых хранилищ и полных
проектных задач. Для каждой недели указаны основные материалы, дополнительные
разборы и практический кейс.
...
- [System Design Interview Questions](./system-design-interview-questions.md) — сгруппированный банк вопросов с краткими ответами: ход интервью, оценка нагрузки, масштабирование, БД, кеши, брокеры, распределённые отказы, совместимые деплои и disaster recovery. Нужен для устного прогона отдельных механизмов и trade-offs перед полными design-кейсами
- [Подготовка по компаниям](./company-preparation/README.md) — возможные system design задачи для Aviasales и Tabby, требования из специфики продукта и обоснованный выбор БД, кешей и очередей. Публичные факты отделены от учебных гипотез; внутри — приоритеты подготовки, упражнения и ссылки на полные кейсы
- [C4-диаграммы для System Design Interview](./c4-model/README.md) — как разделять System Context, Container, Component и Code, когда добавлять Dynamic/Deployment diagrams и что реально рисовать на собеседовании. Внутри — визуальный сквозной пример Low Price Alerts от границы системы до Matcher и multi-AZ deployment
