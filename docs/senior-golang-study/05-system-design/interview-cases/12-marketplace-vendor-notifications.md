...
*Почему per-vendor CB:* лежащий эндпоинт одного vendor'а не должен исчерпывать воркеры и тормозить остальных. Паттерн — [reliability / circuit breaker](../reliability-patterns/03-circuit-breaker.md); приём доставки и подпись — [protocols / webhooks](../../08-networking-and-api/protocols/05-integration-patterns/01-webhooks.md).
...
- [Webhooks protocol](../../08-networking-and-api/protocols/05-integration-patterns/01-webhooks.md) — design webhook contracts
