...
Если нужно спроектировать самого провайдера рассрочки, а не подключить способ
оплаты, см. [BNPL Service: Tabby / Klarna](../../../../05-system-design/interview-cases/32-bnpl-service.md).
Там отдельно разобраны кредитный лимит, график взносов, выплаты продавцам и долг
покупателя — это другой уровень задачи, чем интеграция магазина с PSP.
