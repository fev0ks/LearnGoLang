...
**1. Почему нельзя использовать `http.DefaultClient` в production?**
...
**2. Что такое connection pooling в HTTP клиенте и почему важно закрывать resp.Body?**
...
**3. Как реализовать retry безопасно?**
