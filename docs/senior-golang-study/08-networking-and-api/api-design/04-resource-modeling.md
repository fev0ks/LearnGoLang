...
- [Sub-resource vs top-level](#sub-resource-vs-top-level)
- [Глубина вложенности](#глубина-вложенности)
- [Когда `/parent/{id}/children` vs `/children?parentId=X`](#когда-parentidchildren-vs-childrenparentidx)
- [Bulk-операции](#bulk-операции)
- [Подресурсы с одним значением (singleton)](#подресурсы-с-одним-значением-singleton)
- [Альтернативные представления одного ресурса](#альтернативные-представления-одного-ресурса)
- [Альтернативные «коллекции» одного ресурса](#альтернативные-коллекции-одного-ресурса)
- [Пример: моделирование одного домена](#пример-моделирование-одного-домена)
...
/v1/orders/{orderId}/payments/{paymentId}/refunds                 # 5 — уровень вложенности, который стоит пересмотреть
