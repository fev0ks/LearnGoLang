...
- [1. Запрос попадает в web server](#1-запрос-попадает-в-web-server)
- [2. Middleware chain](#2-middleware-chain)
- [3. Business logic](#3-business-logic)
- [4. Доступ к данным](#4-доступ-к-данным)
- [5. Формирование ответа](#5-формирование-ответа)
- [Где здесь бывают проблемы](#где-здесь-бывают-проблемы)
- [Почему это только часть маршрута](#почему-это-только-часть-маршрута)
