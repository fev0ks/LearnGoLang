...
Аутентификация — это "кто это?". Авторизация — "что этому субъекту можно?". Сначала нужно понять первое, потом решать второе.
...
| Кто субъект | биометрия (Touch ID, Face ID) | ← сильнее |
