...
#to-top{position:absolute;bottom:100px;right:100px;width:50px;height:50px;border-radius:50%;background:#334155;color:#e2e8f0;border:none;cursor:pointer;font-size:18px;display:flex;align-items:center;justify-content:center;opacity:0;pointer-events:none;transition:opacity .2s,background .15s;z-index:100}
