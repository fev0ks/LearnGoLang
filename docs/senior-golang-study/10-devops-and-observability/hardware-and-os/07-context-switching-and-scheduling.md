# Переключение контекста и планирование CPU
...
Не запускайте бесконечный CPU loop с высоким RT priority на рабочей машине: он способен вытеснить обычные системные задачи.
