...
В Go обычно работают с **goroutines** — это **не** OS threads. Понимание этой разницы — ключ к пониманию того, как Go масштабируется до миллионов "потоков" на одной машине, тогда как OS thread'ов на той же машине бывает максимум десятки тысяч.
