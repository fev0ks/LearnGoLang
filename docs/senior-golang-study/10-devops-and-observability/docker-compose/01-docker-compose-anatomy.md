...
- [Базовая модель Compose файла](#базовая-модель-compose-файла)
- [Как читать Compose на Go-проекте](#как-читать-compose-на-go-проекте)
- [Что важно помнить](#что-важно-помнить)
- [Что не решает Compose](#что-не-решает-compose)
- [Куда идти за деталями](#куда-идти-за-деталями)
