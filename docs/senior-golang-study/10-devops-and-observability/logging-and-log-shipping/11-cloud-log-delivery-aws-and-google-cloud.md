...
- [AWS: Частые паттерны](#aws-частые-паттерны)
- [Google Cloud и GCS: Частые паттерны](#google-cloud-и-gcs-частые-паттерны)
- [Что выбирать на практике](#что-выбирать-на-практике)
- [S3 и GCS: что важно помнить](#s3-и-gcs-что-важно-помнить)
