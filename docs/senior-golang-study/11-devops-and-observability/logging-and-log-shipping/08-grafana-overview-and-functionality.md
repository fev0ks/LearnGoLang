...
- [Что такое Grafana по сути](#что-такое-grafana-по-сути)
- [Главные сущности в Grafana](#главные-сущности-в-grafana)
- [Как Grafana работает с разными типами сигналов](#как-grafana-работает-с-разными-типами-сигналов)
- [Что такое Tempo внутри grafana-стека](#что-такое-tempo-внутри-grafana-стека)
- [Почему Grafana часто любят platform teams](#почему-grafana-часто-любят-platform-teams)
- [Где Grafana особенно сильна](#где-grafana-особенно-сильна)
- [Где Grafana не стоит идеализировать](#где-grafana-не-стоит-идеализировать)
- [Типичный workflow расследования через Grafana](#типичный-workflow-расследования-через-grafana)
