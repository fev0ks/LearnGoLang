...
- [Из чего состоит пайплайн](#из-чего-состоит-пайплайн)
- [Почему сервис не пишет прямо в storage](#почему-сервис-не-пишет-прямо-в-storage)
- [Structured Logs](#structured-logs)
- [Где запускают collector](#где-запускают-collector)
- [Что происходит внутри collector](#что-происходит-внутри-collector)
- [Основные способы передачи логов](#основные-способы-передачи-логов)
- [Надёжность и trade-offs](#надёжность-и-trade-offs)
- [Hot, Warm, Cold Storage](#hot-warm-cold-storage)
- [Как выбирать backend](#как-выбирать-backend)
