...
- [Алгоритмические задачи с собеседований](./company-algorithmic-tasks.md) — 24 задачи на массивы, hash map, два указателя, heap, графы и деревья; решения скрыты для самостоятельной тренировки
