...
- **Тесты** — даже упрощённые, показывают, что кандидат думает о corner cases.
...
- какой production incident разобрать как пример ownership;
- какие 3 архитектурных решения из прошлого опыта можно защитить аргументами;
- где было техническое ошибочное решение и что изменилось в подходе после этого;
- какие вопросы задать компании про масштаб, команду и инженерную культуру.
