...
gRPC streaming — альтернатива брокеру для связи сервис-сервис в реальном времени: постоянное соединение HTTP/2 вместо опроса очереди. Основы gRPC — [03-api-styles/02-grpc.md](../08-networking-and-api/protocols/03-api-styles/02-grpc.md), механика потоков и управления окнами HTTP/2 — [02-http/01-http-versions.md](../08-networking-and-api/protocols/02-http/01-http-versions.md).
...
У HTTP/2 есть встроенное управление потоком по окнам: получатель объявляет, сколько байт готов принять, и отправитель останавливается, когда окно исчерпано. Механика окон разобрана в [02-http/01-http-versions.md](../08-networking-and-api/protocols/02-http/01-http-versions.md).
...
Hub-паттерн с буфером на клиента и горутинами-писателями разобран в [04-realtime/01-websocket.md](../08-networking-and-api/protocols/04-realtime/01-websocket.md), backplane на Redis — в [05-redis-pubsub.md](./05-redis-pubsub.md).
